...
def test_steam_fields_defaults():
    ...
    assert cfg.steam_cdn_assets_enabled is True

def test_steam_fields_from_dict():
    cfg = AppConfig(steam_api_key="ABCD1234", steam_id64="76561198012345678", match_mode="competitive", match_count=50, steam_cdn_assets_enabled=False)
    ...
    assert cfg.steam_cdn_assets_enabled is False
